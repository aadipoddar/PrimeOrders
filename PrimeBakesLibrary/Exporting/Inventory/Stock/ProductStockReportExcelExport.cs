...
public static class ProductStockReportExcelExport
{
        ...
        string locationName = null)
    {
        ...
        var columnSettings = new Dictionary<string, ExcelExportUtil.ColumnSetting>
        {
            ...
            ["ProductId"] = new() { DisplayName = "Product ID", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignCenter, IncludeInTotal = false, Width = 12 },
            ["ProductCategoryId"] = new() { DisplayName = "Category ID", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignCenter, IncludeInTotal = false, Width = 12 },

            // Text fields
            ["ProductName"] = new() { DisplayName = "Product Name", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignLeft, Width = 25 },
            ["ProductCode"] = new() { DisplayName = "Product Code", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignCenter, Width = 15 },
            ["ProductCategoryName"] = new() { DisplayName = "Category", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignLeft, Width = 20 },
            ...
            ["LastSalePrice"] = new() { DisplayName = "Last Sale Price", Format = "#,##0.00", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignRight, IncludeInTotal = false, Width = 18 },
            ["LastSaleValue"] = new() { DisplayName = "Last Sale Value", Format = "#,##0.00", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignRight, IncludeInTotal = true, HighlightNegative = true, Width = 18 }
        };
        ...
        string locationName = null)
    {
        ...
        var detailsColumnSettings = new Dictionary<string, ExcelExportUtil.ColumnSetting>
        {
            ...
            ["LocationId"] = new() { DisplayName = "Location ID", Alignment = Syncfusion.XlsIO.ExcelHAlign.HAlignCenter, IncludeInTotal = false, Width = 12 },
