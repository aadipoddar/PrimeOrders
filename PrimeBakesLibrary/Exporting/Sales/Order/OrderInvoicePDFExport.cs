...
/// <summary>
/// Convert Order data to Invoice PDF format
/// </summary>
public static class OrderInvoicePDFExport
{
    /// <summary>
    /// Export Order as a professional invoice PDF (automatically loads item names)
    /// </summary>
        ...
        string outlet = null)
    {
        ...
        var lineItems = orderDetails.Select(detail =>
        {
            ...
            return new PDFInvoiceExportUtil.InvoiceLineItem
            {
                ...
                TotalTaxAmount = 0,
                Total = 0
                // Note: Order detail remarks stored separately, not in line items
            };
        }).ToList();
        ...
        string outlet = null)
    {
        ...
        var lineItems = orderItems.Select(item => new PDFInvoiceExportUtil.InvoiceLineItem
        {
            ItemId = item.ItemId,
