...
public partial class StockTransferReport : IAsyncDisposable
{
	...
	private async Task LoadTransactionOverviews()
	{
		...
		try
		{
			...
			_transactionOverviews = await StockTransferData.LoadStockTransferOverviewByDate(
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var stream = await Task.Run(() =>
				StockTransferReportExcelExport.ExportStockTransferReport(
	...
	private async Task ExportPdf()
	{
		...
		try
		{
			...
			var stream = await Task.Run(() =>
				StockTransferReportPdfExport.ExportStockTransferReport(
					_transactionOverviews.Where(_ => _.Status),
					dateRangeStart,
					dateRangeEnd,
					_showAllColumns,
